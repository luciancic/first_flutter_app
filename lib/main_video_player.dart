...
void main() {
  print('main');
  print('printing a buch more stuff!');
  int? asdf;
  if (asdf == null) {
    print('asdf is null');
  } else {
    print('asdf is not null');
  }
  final Uri uri = Uri.https('authority');
  runApp(
    MaterialApp(
      home: _App(),
    ),
...
class _ButterFlyAssetVideoState extends State<_ButterFlyAssetVideo> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/2023-07-23-skate.mp4');
...
class _BumbleBeeRemoteVideoState extends State<_BumbleBeeRemoteVideo> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(
      Uri.parse(
          'https://storjcdn.condrea.dev/2023-07-28%20fakie%20fs%20board%20best%20try.mp4'),
...
class _PlayerVideoAndPopPageState extends State<_PlayerVideoAndPopPage> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset('assets/2023-07-23-skate.mp4');
